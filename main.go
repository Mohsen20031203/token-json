...
func newDriver() webDriver {
	...
	chromeArgs := []string{"--headless", "--disable-gpu", "--window-size=1920x1080"}
	...
	fmt.Println(driver.MaximizeWindow(""))

	// No need to maximize a headless browser window
	log.Println("WebDriver session created successfully in headless mode.")
...
func (wd webDriver) fetchContract(contract string) (string, error) {
	...
	searchBox.Click()
	var searchBoxModal selenium.WebElement

	xpath = `/html/body/div[3]/div[6]/div/div/div/div[1]/div[1]/div[1]/input`
	for i := 0; ; i++ {
	...
	xpath = `/html/body/div[3]/div[6]/div/div/div/div[1]/div[3]/div[1]`
	for i := 0; ; i++ {
	...
	xpath = `/html/body/div[3]/div[6]/div/div/div/div[1]/div[3]/div[1]/a[1]/div`
	coin, err = wd.driver.FindElement(selenium.ByXPATH, xpath)
	if err != nil {
		return "0", err
	}
